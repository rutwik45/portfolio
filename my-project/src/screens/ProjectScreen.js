    ...
    return(
        <div className='bg-zinc-700 text-white my-200 shadow-2xl shadow-cyan-500/50'>
            ...
            <div className='md:ml-auto flex flex-wrap grid grid-cols-2 bg-slate-100 my-200 shadow-2xl '>
                ...
                <div className='flex flex-col ml-40 overflow-hidden rounded-md'>
                    <a href='https://rststore3.herokuapp.com/' target='_blank'>
                        <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded my-5 w-[300px]'>View Site</button>
                    </a>
                    <a href='https://github.com/rutwik45/rststore' target='_blank'>
                        <button  className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-[300px] my-5'>View Code</button>
                    </a>
